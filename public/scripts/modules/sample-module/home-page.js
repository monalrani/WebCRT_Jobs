define(['angular', './sample-module'], function (angular, controllers) {
    ...
    $scope.lastWeekChatArr = [{'imageSrc':'\\images\\Lorenzo_Simonelli.png', 'name':'Lorenzo Simonelli', 'message':'As a world leader in advanced technologies and services, GE Oil & Gas is well positioned to foster growth in India\'s domestic production - from extraction to transportation to end use.'},
    ...
    $scope.lastMonthChatArr = [{'imageSrc':'\\images\\Ganesh_Bell.jpg', 'name':'Ganesh Bell', 'message':'FLX360 flying lead, multi-function subsea connection system. Innovative design increases long term equipment reliability and operating efficiency'},
                               ...
                               {'imageSrc':'\\images\\Kelly_Lafnitzegger.jpg', 'name':'Kelly Lafnitzegger', 'message':'Driving development with the Digital Solutions. Today, technology and the Internet are seen as new avenues to economic growth'},
                               {'imageSrc':'\\images\\Lorraine_Bolsinger.jpg', 'name':'Lorraine Bolsinger', 'message':'Response Max. A Predictivity solution to significantly increase maintenance efficiency while reducing cost and time'}];
        ...
        $scope.submitClicked = function($event) {
            ...
            var chatText = area.value;
             var chatObj = {"image-src":'\\images\\Lorenzo_Simonelli.png', 'name':'Logged User'};
